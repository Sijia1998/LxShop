<template>
    <div>
            ...
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="position: absolute; width: 0px; height: 0px; overflow: hidden;">
                <defs>
                    ...
                    <symbol id="icon-ok" viewBox="0 0 32 32">
                        <title>ok</title>
                        <path d="M14.084 20.656l-7.845-9.282c-1.288-1.482-3.534-1.639-5.016-0.351s-1.639 3.534-0.351 5.016l10.697 12.306c1.451 1.669 4.057 1.623 5.448-0.096l18.168-22.456c1.235-1.527 0.999-3.765-0.528-5.001s-3.765-0.999-5.001 0.528l-15.573 19.337z" class="path1"></path>
                    </symbol>
                    ...
                    <symbol id="icon-clock" viewBox="0 0 32 32">
                        <title>clock</title>
                        <path d="M29.333 16c0-7.364-5.97-13.333-13.333-13.333s-13.333 5.97-13.333 13.333c0 7.364 5.97 13.333 13.333 13.333s13.333-5.97 13.333-13.333v0 0 0 0 0 0zM0 16c0-8.837 7.163-16 16-16s16 7.163 16 16c0 8.837-7.163 16-16 16s-16-7.163-16-16zM14.667 14.667v1.333h2.667v-10.667h-2.667v9.333zM24 18.667h1.333v-2.667h-10.667v2.667h9.333z" class="path1"></path>
                    </symbol>
                    <symbol id="icon-question" viewBox="0 0 32 32">
                        <title>question</title>
                        <path d="M16 2.56c7.411 0 13.44 6.029 13.44 13.44s-6.029 13.44-13.44 13.44c-7.411 0-13.44-6.029-13.44-13.44s6.029-13.44 13.44-13.44zM16 0c-8.822 0-16 7.178-16 16s7.178 16 16 16c8.822 0 16-7.178 16-16s-7.178-16-16-16z" class="path1"></path>
                        <path d="M16 22.080c-1.059 0-1.92 0.861-1.92 1.92s0.861 1.92 1.92 1.92c1.059 0 1.92-0.861 1.92-1.92s-0.861-1.92-1.92-1.92z" class="path2"></path>
                        <path d="M12.16 12.48c0.706 0 1.28-0.574 1.28-1.28 0-1.412 1.148-2.56 2.56-2.56s2.56 1.148 2.56 2.56c0 1.412-1.148 2.56-2.56 2.56-0.706 0-1.28 0.574-1.28 1.28v3.84c0 0.706 0.574 1.28 1.28 1.28s1.28-0.574 1.28-1.28v-2.723c2.224-0.575 3.84-2.616 3.84-4.957 0-2.823-2.297-5.12-5.12-5.12s-5.12 2.297-5.12 5.12c0 0.706 0.574 1.28 1.28 1.28z" class="path3"></path>
                    </symbol>
                </defs>
            </svg>
            <div class="container">
                <div class="checkout-addr">
                    ...
                    <div class="addr-list-wrap">
                        <div class="addr-list">
                            <ul>
                                <li class="" v-for="(item,index) in addressInfoFilter" @click="checkIndex=index" :class="{'check':checkIndex==index}">
                                    ...
                                    <div class="addr-opration addr-edit" style="display: none;">
                                    ...
                                    <div class="addr-opration addr-del">
                                        <a href="javascript:;" class="addr-del-btn" @click="delAddConfirm(item)">
                        ...
                        <div class="shipping-addr-more">
                            <a href="javascript:;" class="addr-more-btn up-down-btn" @click="expand" :class="{'open':limit>3}">
                                more
                                <i class="i-up-down">
                ...
                <div class="md-modal modal-msg md-modal-transition">
                    <div class="md-modal-inner">
                        ...
                        <div class="md-content">
                            ...
                            <div class="btn-wrap">
                                <div>
                                    <a href="javascript:;" class="btn btn--m">好的</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <model :mdShow="isMdShow" @close="closeModel">
            ...
            <div slot="btnGroup">
                <a href="javascript:;" class="btn btn--m" @click="removeAdd">确认</a>
...
export default {
    ...
    computed: {
        addressInfoFilter() {
            return this.addressInfo.slice(0, this.limit);
        }
    },
    methods: {
        getAddress() {
        ...
        expand() {
            if (this.limit == 3) {
                this.limit = this.addressInfo.length;
            } else {
                this.limit = 3
            }
        },
